...
function winGame() {
  ...
  setTimeout(() => {
    ...
    typeWriter(
      "နောက်ဆုံးတော့မင်အနိုင်ရဲ့သွားခဲ့ပြီဘာကြောင့်လဲဆိုတော့မင်အရှံးမပေလို့ပဲkayလေကအရမ်းသန်မာတဲ့ကောင်မလေပါ အမြဲမှတ်ထားပါ Kayလေဘေးမှာ Akira အမြဲရှိပါတယ် Kayလေကိုakiraအရမ်းချစ်သလိုkayလေ၀မ်းနည်းမှာလဲ Akira မမြင်ရက်ဘူးဒါကြောင့်အရှံးမပေပါနဲ့ပျော်ပျော်ရွင်ရွင်ပဲနေပါ \n\nအရမ်းချစ်တယ်အချစ်ဆုံးလေkayဂရုစိုက်ပါပျော်အောင်နေပါအရမ်းချစ်တယ်အာဘွား",
      "typedText",  // <- ဒီနေရာ
      40
    );
  }, 100);
